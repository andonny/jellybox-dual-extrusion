...
#ifndef MOTHERBOARD
 //AG changed motherboard from MOTHERBOARD BOARD_RAMPS_13_EFB to MOTHERBOARD BOARD_RAMPS_13_EEF which now enables 2 extruders because EEF stands for extruder, extruder, fan
...
#define CUSTOM_MACHINE_NAME "JB Dual Color is"
...
// :[1,2,3,4]
//AG changed to 2 extruders
#define EXTRUDERS 2
//defined singlenozzle which tells the printer that there will be 2 extruders and 1 hot end
#define SINGLENOZZLE
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define AUTO_BED_LEVELING_GRID_POINTS 2
      ...
      // FG points for Jellybox 0.9 style bed in place below.
      // we strongly recommend the use of the grid though!
      ...
      //FG min X requires X_MIN_POS -30 while our X_PROBE_OFFSET_FROM_EXTRUDER 30
...
//FG hardcoded homing point for the probe to be on the left side
    //#define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 2)    // X point for Z homing when homing all axis (G28).
    //define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2)    // Y point for Z homing when homing all axis (G28).
    #define Z_SAFE_HOMING_X_POINT (17)    // X point for Z homing when homing all axis (G28).
    #define Z_SAFE_HOMING_Y_POINT (13)    // Y point for Z homing when homing all axis (G28).
...
//fg modify as per Tom sanladeder from 1 -> 4
#define ENCODER_PULSES_PER_STEP 4 // Increase if you have a high resolution encoder

//fg modify as per Tom sanladeder from 5 -> 1
